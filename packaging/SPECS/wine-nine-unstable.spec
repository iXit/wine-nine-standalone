# spec file for package wine-nine-unstable
#
...
Name:             %{pkgname}-unstable
Version:          4.0
Release:          %{?patchlevel}%{?dist}
Summary:          Wine D3D9 interface library for Mesa's Gallium Nine statetracker. Untested releases from master branch.
License:          LGPL-2.0
...
Untested build from master branch, commit %{commithash}.
